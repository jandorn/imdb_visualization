  ...
  <PageLayout>
    <div class="w-full justify-start text-lg">
      <div>
        ...
        Let's have a look at the histograms of average ratings. The y-axes of the histograms are scaled to their respective maximum value for better visibility.<br><br>
      </div>
    </div>
